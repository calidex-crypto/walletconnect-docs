...
const provider = await EthereumProvider.init({
  ...
  metadata: {
    ...
    url: 'https://buyfromcali.com', // origin must match your domain & subdomain
  ...
  rpcMap: {
    1: 'https://virtual.mainnet.rpc.tenderly.co/eb24f6ac-81d3-4d0e-a640-83e9414ee0d0',
    137: 'https://virtual.polygon.rpc.tenderly.co/ea55feb5-6da1-42d0-8875-3d2f8c874e17'
  }
})
```
